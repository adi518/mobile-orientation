...
exports.MobileOrientation = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // https://davidwalsh.name/orientation-change
...
// Implementation
var MobileOrientation = exports.MobileOrientation = function () {
  ...
  _createClass(MobileOrientation, [{
    key: 'isMobile',
    get: function get() {
      var isTouchDevice = window.navigator.msMaxTouchPoints || 'ontouchstart' in document;
      var isIos = !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform);
      var isIosFallback = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
